use crate::{
    ...
    osurelax::object::OsuRelaxObject,
};
...
impl OsuRelaxSkills {
    pub fn new(
        ...
        let hit_window = 2.0 * map_attrs.hit_windows().od_great.unwrap_or(0.0);
        ...
        let time_fade_in = if mods.hd() {
            ...
            400.0 * (time_preempt / OsuRelaxObject::PREEMPT_MIN).min(1.0)
        };
