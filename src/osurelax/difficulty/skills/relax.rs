...
define_skill! {
    #[derive(Clone)]
    pub struct Relax: StrainSkill => [OsuRelaxDifficultyObject<'a>][OsuRelaxDifficultyObject<'a>] {
...
impl RelaxAimEvaluator {
    ...
    fn evaluate_diff_of<'a>(
        ...
        const RADIUS: i32 = OsuRelaxDifficultyObject::NORMALIZED_RADIUS;
        #[allow(clippy::items_after_statements)]
        const DIAMETER: i32 = OsuRelaxDifficultyObject::NORMALIZED_DIAMETER;
