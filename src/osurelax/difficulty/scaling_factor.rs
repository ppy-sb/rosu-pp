...
use super::object::OsuRelaxDifficultyObject;
...
impl ScalingFactor {
    pub fn new(cs: f64) -> Self {
        ...
        let radius = f64::from(OsuRelaxObject::OBJECT_RADIUS * scale);
        let factor = OsuRelaxDifficultyObject::NORMALIZED_RADIUS as f32 / radius as f32;
