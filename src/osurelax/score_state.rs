...
impl OsuRelaxScoreState {
    ...
    pub fn accuracy(&self, origin: OsuRelaxScoreOrigin) -> f64 {
...
impl Default for OsuRelaxScoreState {
    fn default() -> Self {
        Self::new()
    }
}

impl From<crate::osu::OsuScoreState> for OsuRelaxScoreState {
    fn from(s: crate::osu::OsuScoreState) -> Self {
        Self {
            max_combo: s.max_combo,
            large_tick_hits: s.hitresults.large_tick_hits,
            small_tick_hits: s.hitresults.small_tick_hits,
            slider_end_hits: s.hitresults.slider_end_hits,
            n300: s.hitresults.n300,
...
/// Type to pass [`OsuRelaxScoreState::accuracy`] and specify the origin of a score.
#[derive(Copy, Clone, Debug, PartialEq, Eq)]
pub enum OsuRelaxScoreOrigin {
